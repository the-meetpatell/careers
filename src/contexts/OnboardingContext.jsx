...
const BADGES = [
  ...
  { id: 'values-master', title: 'Values Master', icon: '💎', condition: (progress) => progress.completedSteps.filter(s => s.includes('relentless-customer-centricity') || s.includes('togetherness') || s.includes('transparency-integrity') || s.includes('unprompted-ownership') || s.includes('scalable-innovation-excellence')).length >= 5 },
