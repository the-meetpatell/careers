...
const ONBOARDING_STEPS = [
  ...
  { id: 'integrity', title: 'Integrity', icon: '🧭', required: false },
  { id: 'never-stop-learning', title: 'Never Stop Learning', icon: '📚', required: false },
  { id: 'striving-excellence', title: 'Striving for Excellence', icon: '🏆', required: false },
  { id: 'proactive-ownership', title: 'Proactive Ownership', icon: '🧡', required: false },
  { id: 'inventiveness', title: 'Inventiveness', icon: '🛠️', required: false },
  { id: 'resilience', title: 'Resilience', icon: '💪', required: false },
  { id: 'expansion-mindset', title: 'Expansion Mindset', icon: '🚀', required: false },
...
const BADGES = [
  ...
  { id: 'values-master', title: 'Values Master', icon: '💎', condition: (progress) => progress.completedSteps.filter(s => s.includes('integrity') || s.includes('never-stop-learning') || s.includes('striving') || s.includes('proactive-ownership') || s.includes('inventiveness') || s.includes('resilience') || s.includes('expansion-mindset')).length >= 5 },
