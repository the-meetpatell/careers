...
const ROLE_GROUPS = [
  {
    ...
    roles: [
      ...
      {
        title: 'SDR Manager',
        tag: 'Revenue • Remote/Dubai',
        description: 'Lead the SDR function, coach a team, and build predictable outbound pipeline.',
        to: '/virtual-drive/sdr-manager',
  ...
  },
  {
    ...
    roles: [
      ...
      {
        title: 'Growth UI/UX Designer',
        tag: 'Marketing • Remote',
        description: 'Design growth experiments, onboarding journeys, and landing pages that convert.',
        to: '/virtual-drive/growth-ui-ux-designer',
        accent: 'from-sky-500 to-indigo-500',
        chipBg: 'bg-sky-100 text-sky-700',
      },
      {
        title: 'Field Marketing Manager (Arabic is a plus)',
        tag: 'Marketing • Dubai',
      ...
      },
      {
        ...
        to: '/virtual-drive/video-producer-editor',
