    ...
    roles: [
      {
        ...
        to: '/new-hiring/vas-revenue-vendor-partnerships-executive',
        accent: 'from-blue-500 to-cyan-500',
        chipBg: 'bg-blue-100 text-blue-700',
      },
      {
        title: 'Global BDM — Finance Process Outsourcing',
        tag: 'Revenue • Global',
        description: 'Drive global business development for finance process outsourcing services, building pipeline across key international markets.',
        to: '/new-hiring/outbound-sales-india-business-development',
    ...
    roles: [
      {
        ...
        to: '/new-hiring/engineering-lead',
      ...
      },
      {
        ...
        to: '/new-hiring/devops-engineer-part-time',
    ...
    roles: [
      {
        ...
        to: '/new-hiring/senior-talent-acquisition',
        accent: 'from-indigo-600 to-blue-600',
        chipBg: 'bg-indigo-100 text-indigo-700',
      },
    ],
