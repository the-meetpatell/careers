...
import { ArrowLeft, MapPin, Briefcase, Users, Calendar, PenLine, CheckCircle, BookOpen } from 'lucide-react'
            ...
            <div className="lg:col-span-2">
              <AnimatedSection animation="fade-up">
                ...
                <div className="mb-6 sm:mb-8">
                  <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-gradient-to-r from-sky-500 to-blue-600 text-white text-xs sm:text-sm font-bold mb-3 sm:mb-4">
                    ✍️ Marketing
                  </div>
              ...
              <AnimatedSection animation="fade-up" delay={100}>
                <Card className="mb-6 bg-gradient-to-br from-sky-50 to-blue-50 border-2 border-sky-200">
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <div className="space-y-2 text-slate-700 font-medium text-sm sm:text-base">
                      ...
                      <p className="text-sky-600 font-bold mt-3 sm:mt-4">Only candidates who apply before Friday the 5th Dec will be scheduled.</p>
                    </div>
                  </div>
                </Card>
              </AnimatedSection>
                ...
                <Card className="mb-6">
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                      Craft crisp, founder-first content for campaigns, landing pages, and product storytelling. You’ll translate complex finance topics into clear, engaging narratives.
                    </p>
                    <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                      Ideal for writers who thrive in fast-paced teams, obsess over clarity, and can switch between conversion copy and thought leadership.
                    </p>
                  </div>
                </Card>
              </AnimatedSection>
                ...
                <Card className="mb-6">
                  <div className="p-4 sm:p-6 md:p-8">
                    <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6 flex items-center gap-2">
                      <PenLine className="text-sky-600 flex-shrink-0" size={24} />
                      Key Responsibilities
                    </h2>
                    <ul className="space-y-3 sm:space-y-4">
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Write high-conversion copy for ads, emails, and landing pages.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Develop blog content and thought leadership for founders.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Collaborate with design and growth teams to align messaging.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Optimize content for SEO and campaign performance.</span>
                      </li>
                    </ul>
                  </div>
                </Card>
                  ...
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <ul className="space-y-3 sm:space-y-4">
                      <li className="flex items-start gap-2 sm:gap-3">
                        ...
                        <span className="text-sm sm:text-base text-slate-700">3+ years writing marketing content in English.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-sky-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Portfolio showing ads, landing pages, and long-form pieces.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-sky-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Ability to simplify complex/financial topics.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-sky-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Comfort with SEO basics and performance tracking.</span>
                      </li>
                    </ul>
                  </div>
                </Card>
                ...
                <Card className="mb-6 sm:mb-8">
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <ul className="space-y-3 sm:space-y-4">
                      ...
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Remote-first setup with structured feedback loops.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Learning budget and access to industry experts.</span>
                      </li>
                    </ul>
                  </div>
                </Card>
                ...
                <div className="lg:sticky lg:top-24">
                  <Card className="shadow-xl bg-white overflow-hidden">
                    <div className="bg-gradient-to-r from-sky-500 to-blue-600 p-4 sm:p-6 text-white">
                      ...
                      <p className="text-sky-50 text-xs sm:text-sm">Join our Marketing Team</p>
                    </div>
