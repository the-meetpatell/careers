          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="lg:col-span-2">
              <AnimatedSection animation="fade-up">
                <Link to="/finops-career-drive" className="inline-flex items-center gap-2 text-amber-600 hover:text-amber-700 font-semibold mb-6 sm:mb-8 group text-sm sm:text-base">
                ...
                <Card className="mb-6 bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200">
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <div className="space-y-2 text-slate-700 font-medium text-sm sm:text-base">
                      ...
                      <p className="text-amber-700 font-bold mt-3 sm:mt-4">Submit now to get scheduled for the 13th GD and weekend technical rounds.</p>
                    </div>
                  </div>
                </Card>
              </AnimatedSection>
                ...
                <Card className="mb-6">
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                      Lead day-to-day execution for pods, keep books clean, and coach Sr/Jr associates. You’ll ensure reconciliations, closes, and reporting stay on track.
                    </p>
                    <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                      You work closely with controllers and account managers to surface risks, fix process gaps, and deliver a smooth client experience.
                    </p>
                ...
                <Card className="mb-6">
                  <div className="p-4 sm:p-6 md:p-8">
                    <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6 flex items-center gap-2">
                      <ClipboardList className="text-amber-600 flex-shrink-0" size={24} />
                      Key Responsibilities
                    </h2>
                    <ul className="space-y-3 sm:space-y-4">
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Monitor daily reconciliations, AP/AR hygiene, and close tasks executed by the pod; unblock the team and ensure quality.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Allocate work across associates and ensure quality control on deliverables.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Lead client communication on status, risks, and next steps; surface escalations early with controllers/AMs.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Review and deliver monthly reports to clients, ensuring accuracy and clarity of insights.</span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="text-green-600 flex-shrink-0 mt-1" size={18} />
                        <span className="text-sm sm:text-base text-slate-700">Coach team members; build playbooks to speed up delivery and accuracy.</span>
                      </li>
                    </ul>
                  </div>
                </Card>
                  ...
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <ul className="space-y-3 sm:space-y-4">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-sm sm:text-base text-slate-700">4–6 years in accounting/finops with experience leading small teams.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="text-amber-600 flex-shrink-0 mt-1" size={20} />
                        <span className="text-sm sm:text-base text-slate-700">Strong on reconciliations, closes, and preparing management reports.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="text-amber-600 flex-shrink-0 mt-1" size={20} />
                        <span className="text-sm sm:text-base text-slate-700">Ability to manage workloads, prioritize, and maintain quality in remote teams.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="text-amber-600 flex-shrink-0 mt-1" size={20} />
                        <span className="text-sm sm:text-base text-slate-700">Clear communication and documentation to keep pods aligned.</span>
                      </li>
                    </ul>
                  </div>
                </Card>
                  ...
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <ul className="space-y-3 sm:space-y-4">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-sm sm:text-base text-slate-700">Startup/VC-backed client exposure and familiarity with MENA markets.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="text-blue-600 flex-shrink-0 mt-1" size={20} />
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle className="text-blue-600 flex-shrink-0 mt-1" size={20} />
                        <span className="text-sm sm:text-base text-slate-700">Experience building SOPs/playbooks and mentoring junior staff.</span>
                      </li>
                    </ul>
                  </div>
                </Card>
                ...
                <div className="lg:sticky lg:top-24">
                  <Card className="shadow-xl bg-white overflow-hidden">
                    <div className="bg-gradient-to-r from-amber-500 to-orange-500 p-4 sm:p-6 text-white">
                      ...
                      <p className="text-amber-50 text-xs sm:text-sm">Team Lead - FinOps</p>
                    </div>
