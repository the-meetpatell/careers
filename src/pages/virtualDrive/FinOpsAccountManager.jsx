                ...
                <Card className="mb-6 bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-200">
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <div className="space-y-2 text-slate-700 font-medium text-sm sm:text-base">
                      ...
                      <p className="text-emerald-700 font-bold mt-3 sm:mt-4">Only candidates who apply before Friday, 19th Dec 2025 will be scheduled.</p>
                    </div>
                  </div>
                </Card>
              </AnimatedSection>
                  ...
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <ul className="space-y-3 sm:space-y-4">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-sm sm:text-base text-slate-700">4–6 years in accounting/finops/client delivery; strong client-facing chops.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="text-emerald-600 flex-shrink-0 mt-1" size={20} />
